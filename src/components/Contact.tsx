    ...
    >
      ...
      >
                  ...
                  color:
                    status === 'success'
                      ...
                      : status === 'error'
                        ? 'error.main'
                        : 'text.secondary',
                  fontWeight: status === 'idle' || status === 'sending' ? 400 : 650,
                  lineHeight: 1.55,
                }}
              >
                {statusMessage || 'Your details are used only to reply to this message.'}
              </Typography>
            </Box>
            <Button
              type="submit"
        ...
        >
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: { xs: 1, sm: 2.5 } }}>
            <Box
              component="a"
            ...
            >
              <EmailRoundedIcon aria-hidden sx={{ color: 'primary.main', fontSize: 21 }} />
              {CONTACT_EMAIL}
            </Box>
            <Box
              component="a"
